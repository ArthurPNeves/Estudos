...
int main ( )
{
 ...
 IO_printf ( " 2 -  Digite a quatindade de multiplos de 7 pares que deseja:" );
 IO_printf ( " 3 -  Digite a quatindade de multiplos de 7 impares na ordem decrecente que deseja:\n" );
 IO_printf ( " 4 -   " );
 IO_printf ( " 5 - \n" );
 IO_printf ( " 6 -   " );
 IO_printf ( " 7 - \n" );
