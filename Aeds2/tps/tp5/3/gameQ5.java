...
class No {
	...
	public No(gameQ5 obj, No esq, No dir, int nivel) {
        this.obj = obj;
        this.esq = esq;
        this.dir = dir;
        this.nivel = nivel;
...
class Arvore {
    ...
    public void inserir(gameQ5 game) throws Exception {
        raiz = inserir(raiz, game);
    }

    public No inserir(No i, gameQ5 game) throws Exception {
        if (i == null) {
            i = new No(game);
    ...
    public No balancear(No no) throws Exception {
		if (no != null) {
			...
			// Se desbalanceada para a esquerda
				...
				throw new Exception(
						"Erro no No(" + no.getObj().getName() + ") com fator de balanceamento (" + fator + ") invalido!");
			}
		}
		return no;
	}
