...
class pilha {
    private gameQ6[] Arraypilha = new gameQ6[70];
    private int n = 0;

    public gameQ6[] getArraypilha() {
        return Arraypilha;
    }

    public void setArraypilha(gameQ6[] arraypilha) {
        Arraypilha = arraypilha;
    }
    ...
    public pilha(gameQ6[] arraypilha, int n) {
        Arraypilha = arraypilha;
        this.n = n;
    }

    void inserir(gameQ6 GAME) throws Exception {
    ...
    gameQ6 remover() throws Exception {
        if (n == 0) {
    ...
    void fazerAcoes() throws Exception {
        ...
        for (int i = 0; i < Integer.parseInt(x); i++) {
            ...
            if (aux2.equals("I")) {
                ...
                System.out.println( "(R) "+ remover().getName()  );
    ...
    {
        for (int i = 0; i < n; i++) {
            System.out.println("[" + i + "]" + Arraypilha[i].getJogo());
        }
    }

    gameQ6 lerId(int id) throws Exception
    {
        gameQ6 GAME = new gameQ6();
        String aux = "";
        int j = 0;
        String aux2 = "1";
...
public class gameQ6 {
    ...
    public gameQ6(int app_id, String name, Data release_date, String owners, int age, float price, int dlcs,
