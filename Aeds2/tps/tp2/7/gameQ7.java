...
class fila {
    private gameQ7[] Arrayfila = new gameQ7[6];
    private int primeiro = 0;
    private int ultimo = 0;
    private int media_avgpt = 0;
    private int quntElement = 0;

    public gameQ7[] getArrayfila() {
        return Arrayfila;
    }

    public void setArrayfila(gameQ7[] arrayfila) {
        Arrayfila = arrayfila;
    }
    ...
    public fila(gameQ7[] arrayfila, int primeiro) {
        Arrayfila = arrayfila;
        this.primeiro = primeiro;
    }

    void inserir(gameQ7 GAME) throws Exception {
        ...
        Arrayfila[ultimo] = GAME;
        System.out.println("I " + GAME.getApp_id());
        ultimo = (ultimo + 1) % Arrayfila.length;
        quntElement++;
        fazerMediaAvg();
    }

    void inserirAntesFim(gameQ7 GAME) throws Exception {
        ...
        if (((ultimo + 1) % Arrayfila.length) == primeiro) {
            throw new Exception("Erro inserirAantes");
        }
    ...
    gameQ7 remover() throws Exception {
        if (primeiro == ultimo) {
            throw new Exception("Erro remover");
        }
        gameQ7 resp = new gameQ7();
        resp = Arrayfila[primeiro];
    ...
    gameQ7 removerListaCheia() throws Exception {
        if (primeiro == ultimo) {
            throw new Exception("Erro removerListaCheia");
        }
        gameQ7 resp = new gameQ7();
        resp = Arrayfila[primeiro];
    ...
    void fazerMediaAvg() {
        ...
        int i = primeiro;
        for (; i != ultimo; ) {
            media = media + Arrayfila[i].getAvg_pt();
            i = (i + 1) % Arrayfila.length;
        }
       
        parteinteira = (int) media/quntElement;
        if (media/quntElement - parteinteira >= 0.5) {
            this.media_avgpt = (((int)media)/quntElement) + 1;
        } else {
            this.media_avgpt = (((int)media)/quntElement) ;
        }

        System.out.println(this.media_avgpt);
    }
    ...
    void fazerAcoes() throws Exception {
        ...
        for (int i = 0; i < Integer.parseInt(x); i++) {
            ...
            if (aux2.equals("I")) {
                ...
                inserir(lerId(Integer.parseInt(id)));
    ...
    void imprimirfila() {
        int i = primeiro;
        while (i != ultimo) {
            System.out.println("[" + i + "]" + Arrayfila[i].getJogo());
            i = (i + 1) % Arrayfila.length;
        }
    }

    gameQ7 lerId(int id) throws Exception {
        gameQ7 GAME = new gameQ7();
        String aux = "";
        int j = 0;
        String aux2 = "1";
...
public class gameQ7 {
    ...
    public gameQ7(int app_id, String name, Data release_date, String owners, int age, float price, int dlcs,
