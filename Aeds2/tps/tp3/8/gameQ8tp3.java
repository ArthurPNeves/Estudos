...
class lista {
    private gameQ8tp3[] ArrayLista = new gameQ8tp3[75];
    private int n = 0;
    private int comparacoes = 0;
    private int movimentacoes = 0;
    private long tempofinal = 0;

    public gameQ8tp3[] getArrayLista() {
        return ArrayLista;
    }

    public void setArrayLista(gameQ8tp3[] arrayLista) {
    ...
    public lista(gameQ8tp3[] arrayLista, int n) {
        ArrayLista = arrayLista;
        this.n = n;
    }

    void inserirInicio(gameQ8tp3 GAME) throws Exception {
    ...
    void inserir(gameQ8tp3 GAME, int posicao) throws Exception {
    ...
    void inserirFim(gameQ8tp3 GAME) throws Exception {
        if (n >= ArrayLista.length) {
    ...
    gameQ8tp3 removerInicio() throws Exception {
        if (n == 0) {
            throw new Exception("Erro removerInicio");
        }
        gameQ8tp3 GAME = ArrayLista[0];
    ...
    gameQ8tp3 remover(int posicao) throws Exception {
        if (n == 0 || posicao < 0 || posicao >= n) {
            throw new Exception("Erro remover");
        }

        gameQ8tp3 GAME = ArrayLista[posicao];
        n--;
    ...
    gameQ8tp3 removerFinal() throws Exception {
        if (n == 0) {
    ...
    void ordernarLista()
    {
        for (int i = (n - 1); i > 0; i--) {
			for (int j = 0; j < i; j++) {
				if (ArrayLista[j].getDevelopers().compareTo(ArrayLista[j + 1].getDevelopers()) >= 0 ) {
                    comparacoes++;
               swap(j, j+1);
               movimentacoes++;
				}
     ...
     {
        gameQ8tp3 temp = ArrayLista[x];
        ArrayLista[x] = ArrayLista[y];
        ArrayLista[y] = temp;
      }
     
      public boolean compararDate(gameQ8tp3 primeiro, gameQ8tp3 segundo)
     {
        int mesEmNum1 = 0;
        int mesEmNum2 = 0;
    ...
    gameQ8tp3 lerId(int id) throws Exception {
        gameQ8tp3 GAME = new gameQ8tp3();
        String aux = "";
        int j = 0;
        String aux2 = "1";
    ...
    void escreverLog() throws IOException {
        ...
        BufferedWriter arquivo = new BufferedWriter(new FileWriter("matrícula_bolha.txt"));
...
public class gameQ8tp3 {
    ...
    public gameQ8tp3(int app_id, String name, Data release_date, String owners, int age, float price, int dlcs,
