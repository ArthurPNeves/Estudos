...
class lista {
    private gameQ3tp3[] ArrayLista = new gameQ3tp3[75];
    private int n = 0;
    private int comparacoes = 0;
    private int movimentacoes = 0;
    private long tempofinal = 0;

    public gameQ3tp3[] getArrayLista() {
        return ArrayLista;
    }

    public void setArrayLista(gameQ3tp3[] arrayLista) {
    ...
    public lista(gameQ3tp3[] arrayLista, int n) {
        ArrayLista = arrayLista;
        this.n = n;
    }

    void inserirInicio(gameQ3tp3 GAME) throws Exception {
    ...
    void inserir(gameQ3tp3 GAME, int posicao) throws Exception {
    ...
    void inserirFim(gameQ3tp3 GAME) throws Exception {
        if (n >= ArrayLista.length) {
    ...
    gameQ3tp3 removerInicio() throws Exception {
        if (n == 0) {
            throw new Exception("Erro removerInicio");
        }
        gameQ3tp3 GAME = ArrayLista[0];
    ...
    gameQ3tp3 remover(int posicao) throws Exception {
        if (n == 0 || posicao < 0 || posicao >= n) {
            throw new Exception("Erro remover");
        }

        gameQ3tp3 GAME = ArrayLista[posicao];
        n--;
    ...
    gameQ3tp3 removerFinal() throws Exception {
        if (n == 0) {
    ...
    void ordernarLista()
    {
        long inicio = System.currentTimeMillis();
            ...
            for (int i = 1; i < n; i++) {
                gameQ3tp3 tmp = ArrayLista[i];
                int j = i - 1;
                 while ( (j >= 0) && (ArrayLista[j].getApp_id() > tmp.getApp_id() ) ){
                    comparacoes ++;
                ArrayLista[j + 1] = ArrayLista[j]; 
                movimentacoes++;
                j--;
                }
                ArrayLista[j + 1] = tmp;
    ...
    gameQ3tp3 lerId(int id) throws Exception
    {
        gameQ3tp3 GAME = new gameQ3tp3();
        String aux = "";
        int j = 0;
        String aux2 = "1";
...
public class gameQ3tp3 {
    ...
    public gameQ3tp3(int app_id, String name, Data release_date, String owners, int age, float price, int dlcs,
